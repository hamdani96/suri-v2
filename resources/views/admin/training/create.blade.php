                    ...
                    <form action="{{ route('training.store') }}" method="post" enctype="multipart/form-data"> @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="training_title" value="{{ old('training_title') }}" placeholder="Masukan nama pelatihan" id="" class="form-control">
                            </div>
                            <div class="from-group col-md-12 mb-2">
                                <label for="">Deskripsi <span class="text-danger">*</span></label>
                                <textarea name="training_description" class="@error('training_description') is-invalid @enderror" id="editor">{{ old('training_description') }}</textarea>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Start Score <span class="text-danger">*</span></label>
                                <input type="number" name="start_score" class="form-control" value="{{ old('start_code') }}" id="">
                            </div>
                            <div class="form-group col-md-6 ">
                                <label for="">End Code <span class="text-danger">*</span></label>
                                <input type="number" name="end_score" value="{{ old('end_score') }}" id="" class="form-control">
                            </div>
                            <div class="col-12">

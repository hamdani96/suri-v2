...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-6">
            ...
            <h1 class="mb-0 fw-bold">Data Jabatan</h1>
        </div>
    </div>
</div>
@endsection
                            ...
                            <tbody>
                                @foreach ($positions as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('position.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit </a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<div class="modal fade" id="modal-create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('position.store') }}" method="post"> @csrf
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        <label for="">Nama Jabatan</label>
                        <input type="text" name="position_name" value="{{ old('position_name') }}" placeholder="Masukan nama jabatan" id="" required class="form-control">
                    </div>
                </div>
            </div>

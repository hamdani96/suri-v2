    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="section-title">Hasil Kuis {{ auth()->user()->name }} Score {{ $analysis->score }}</h2>
                <p class="mb-100">Pelatihan Yang Cocok Untuk Kamu</p>
            </div>
            @foreach ($analysis->relatedTrainingAnalysis as $training)
              ...
              {{-- <div class="col-sm-6">
                  <div class="rounded bg-white p-4 shadow-primary">
                      ...
                      <p><a href="#training-{{ $analysis->id }}" data-toggle="collapse" aria-expanded="false" aria-controls="collapseExample">Lihat Hasil Pelatihan Yang Cocok <i class="fa-light fa-arrow-down"></i></a></p>
                  </div>
              </div> --}}

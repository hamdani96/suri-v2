      ...
      <div class="auth-wrapper d-flex no-block justify-content-center align-items-center mt-5">
        <div class="auth-box p-4 bg-white rounded">
          <div id="loginform">
            ...
            <div class="row">
              <div class="col-12">
                <form class="form-horizontal mt-3 form-material" id="loginform" action="{{ route('store-register') }}" method="POST"> @csrf
                  ...
                  <div class="form-group mb-3">
                    <div class="">
                        <select name="hobby_id" required id="" class="form-control">
                  ...
                  <div class="form-group mb-3">
                    <div class="">
                        <select name="position_id" required id="" class="form-control">
                  ...
                  <div class="form-group mb-3">
                    <div class="">
                        <select name="position_status" required id="" class="form-control">
                            <option value="" disabled selected> Pilih Status Jabatan</option>
                            <option value="freelance">Freelance</option>
                            <option value="permanent_employee">Tetap</option>
                  ...
                  <div class="form-group text-center mt-4 mb-3">
                    <div class="col-xs-12">
                      <button type="submit" class="btn btn-primary d-block w-100 waves-effect waves-light">Sign Up</button>
                    </div>
                  </div>
          ...
          <div id="recoverform">
            <div class="logo">
              ...
              <span class="text-muted">Masukan semua data kamu dengan benar!</span>
            </div>
          </div>
        </div>
      </div>
